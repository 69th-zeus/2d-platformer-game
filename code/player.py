...
class Player(pygame.sprite.Sprite):
    def __init__(self, pos, groups, collision_sprites, semi_collision_sprites, frames, data, attack_sound, jump_sound, change_music):
        #general setup
        ...
        for sprite in self.collision_sprites:
            if sprite.rect.colliderect(self.hitbox_rect):
                if axis == 'horizontal':
                    ...
                    #top
                    if self.hitbox_rect.top <= sprite.rect.bottom and int(self.old_rect.bottom) >= int(sprite.old_rect.bottom):
